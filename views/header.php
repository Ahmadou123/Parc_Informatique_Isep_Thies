				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="user_profile"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg>  Profil</a></li>
							<li><a href="../class/logout/logout"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Déconnexion</a></li>
						</ul>
					</li>
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="reservation">
									<span id="reserveBadge2" class="today_reservation badge"></span> - Réservation du jour
								</a>
							</li>
						</ul>
					</li>
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="borrow">
									<span id="dueBorrow" class="badge"></span> - Date d'emprunt 
								</a>
							</li>
						</ul>
					</li>
