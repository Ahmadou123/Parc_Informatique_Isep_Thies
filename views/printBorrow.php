...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">République du senegal</p>
					<p style="margin:0;padding:0;font-weight:bold;">Institut Superieur d'Enseignement Professionel de Thies</p>
					<p style="margin:0;padding:0;">Ville de THIES</p>
				</td>
				<td><img src="logo.png" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="text-align:center; font-weight:bold; padding:30px 0; font-size:18pt; font-family:'Bookman Old Style'; text-transform: uppercase;">Reçu de preuve d’emprun</td>
				<td></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">Nom: <?php echo $data[0]['m_fname']; ?> <?php echo $data[0]['m_lname']; ?></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">Salle: <?php echo ucfirst($data[0]['rm_name']); ?></td>
			</tr>
			<tr>
				<td colspan="3">
					<table style="width:100%; border:1px solid #000; border-bottom: none;" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000;">Categorie</th>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000; border-left:1px solid #000;">Marque</th>
							</tr>
						</thead>
						<tbody>
		...
		echo "<p> Signature de l'emprunteur </p>"; 
		?>
</html>