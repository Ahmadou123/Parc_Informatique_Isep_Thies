				...
				<div class="row">
					<div class="col-md-12">
						<ul class="nav nav-pills">
							<li class="active"><a href="#new" data-toggle="tab"><i class="fa fa-list"></i>&nbsp;&nbsp;Nouveau</a></li>
								...
								<table class="table table_inventory_all">
									<thead>
										<tr>
											<th>Categorie</th>
											<th>Disponible</th>
											<th>Inutilisable (Endommagé/Perdu/Emprunté)</th>
											<th>Total</th>
										</tr>
									</thead>
								</table>
							...
							<div class="tab-pane fade" id="report2">
								<table class="table table_inventory_transfer">
									<thead>
										...
										<label>Sélectionnez un mois:&nbsp &nbsp </label>
																					<?php
