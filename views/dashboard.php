...
?>
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 col-md-2 sidebar">
		...
		<ul class="nav menu" >
			...
			<li style="text: none-decorati; color: #e28743;" class="parent ">
				<a href="#sub-item-1" data-toggle="collapse">
					<span data-toggle="collapse" href="#sub-item-1"></span> 
			...
			<div class="col-sm-9 col-lg-10 col-md-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-3">
				...
				<div class="row">
					<div class="col-sm-offset-3 col-sm-6">
						<h2 style="text-align:center;"> Calendrier de réservation</h2>
						<div id="calendar"></div>
					</div>
				</div>
				<hr/>
